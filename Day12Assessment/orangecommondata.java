...
import org.testng.annotations.DataProvider;
   ...
   public void data() throws IOException {
		...
		FileInputStream fis = new FileInputStream("./src/test/resources/Day12/Orange.properties");
  ...
  @DataProvider
  public Object[][] vacancyData()throws EncryptedDocumentException, IOException {

     FileInputStream fis =new FileInputStream("./src/test/resources/Day12/OrangeHRM.xlsx");
     ...
     for (int row = 1; row <= rowCount; row++) {
        ...
        obj[row - 1][4]=sh.getRow(row).getCell(4).getStringCellValue();
    }
  ...
  public Object[][] employeeData()
      ...
      FileInputStream fis =
              new FileInputStream("./src/test/resources/Day12/OrangeHRM.xlsx");
