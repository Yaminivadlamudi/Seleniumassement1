...
public class OrangeMyInfoPage {
    ...
    public void changeFirstName(String firstName) {
        ...
        firstNameTextField.sendKeys(Keys.COMMAND, "a");
    ...
    public void changeLastName(String lastName) {
        ...
        lastNameTextField.sendKeys(Keys.COMMAND, "a");
    ...
    public void changeEmployeeId(String employeeId) {
        ...
        employeeIdTextField.sendKeys(Keys.COMMAND, "a");

        employeeIdTextField.sendKeys(Keys.DELETE);
